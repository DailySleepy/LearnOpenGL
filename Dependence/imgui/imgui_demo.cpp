...
struct ExampleAssetsBrowser
{
    ...
    int             IconSpacing = 10;
    int             IconHitSpacing = 4;         // Increase hit-spacing if you want to make it possible to clearAllBit or box-select from gaps. Some spacing is required to able to amend with Shift+box-select. Value is small in Explorer.
